...
export const SYSTEM_PORTS = {
  ...
  predictionEngineMetrics: readEnvInt('PREDICTION_ENGINE_METRICS_PORT', 19106),
} as const;
...
export const URLS = {
  ...
  predictionEngineMetrics: `http://${LOCALHOST}:${SYSTEM_PORTS.predictionEngineMetrics}/metrics`,
} as const;
